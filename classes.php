...
<body>
	...
	<header>
		<!--Navbar-->
  		<nav class="navbar navbar-expand-lg navbar-dark danger-color-dark clearfix">
	...
	<main class="mt-5">
        ...
        <h1 class="h1-responsive">Classes for Monday</h1>

          <div class="monday mb-5"></div>

        <h1 class="h1-responsive">Classes for Tuesday</h1>

          <div class="tuesday mb-5"></div>

          <h1 class="h1-responsive">Classes for Wednesday</h1>

          <div class="wednesday mb-5"></div>

          <h1 class="h1-responsive">Classes for Thursday</h1>

          <div class="thursday mb-5"></div>

          <h1 class="h1-responsive">Classes for Friday</h1>

          <div class="friday mb-5"></div>

          <h1 class="h1-responsive">Classes for Saturday</h1>

          <div class="saturday mb-5"></div>
...
<!-- /Modal Sign up -->
    ...
    <!-- Function JavaScript -->
    <script type="text/javascript" src="dist/js/day.js"></script>
</body>
</html>